...
|------|--------------------|--------|-------|
| Database System | MySQL, ER-Diagram | ✅ เสร็จแล้ว | [ดูโปรเจกต์](./SQL) |
| Web Programming | HTML, CSS, PHP | ✅ เสร็จแล้ว | [ดูโปรเจกต์](./Web) |
| Computer Programming | C Language | ✅ เสร็จแล้ว | [ดูโปรเจกต์](./C) |
| Python Programming | Python | ✅ เสร็จแล้ว | [ดูโปรเจกต์](./Python) |
| Object-Oriented Programming | Java | 🛠️ กำลังเรียน | [ดูโปรเจกต์](./Java) |
| Data Science | Python | 🛠️ กำลังเรียน | [ดูโปรเจกต์](./DataScience) |
| Internet of Things | C++ | ✅ เสร็จแล้ว | [ดูโปรเจกต์](./IoT) |
