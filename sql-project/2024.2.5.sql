...
CREATE DATABASE IF NOT EXISTS `nattapong51` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `nattapong51`;
...
-- Dumping structure for table nattapong51.productapp420
CREATE TABLE IF NOT EXISTS `productapp420` (
  `idProduct` char(3) NOT NULL,
  `NameProduct` varchar(35) DEFAULT NULL,
  `Price` int(4) DEFAULT NULL,
  `Numstock` int(4) DEFAULT NULL
...
-- Dumping data for table nattapong51.productapp420: ~9 rows (approximately)
REPLACE INTO `productapp420` (`idProduct`, `NameProduct`, `Price`, `Numstock`) VALUES
	('P01', 'Paper A4 70 g.', 105, NULL),
	('P02', 'Paper A4 80 g.', 120, NULL),
	('P03', 'Paper F4 80 g.', 130, NULL),
	('P04', 'Paper B2 80 g.', 150, NULL),
	...
	('B02', 'Red Pen', 15, NULL),
	('L01', 'Toner printer', 5500, NULL),
	('C01', 'Water Color Art', 250, 10),
	('C02', 'Color Penceils', 120, 20);

-- Dumping structure for table nattapong51.productappbak420
CREATE TABLE IF NOT EXISTS `productappbak420` (
  `idProduct` char(3) NOT NULL,
  `NameProduct` varchar(35) DEFAULT NULL,
  `Price` int(4) DEFAULT NULL,
  `Numstock` int(4) DEFAULT NULL
...
-- Dumping data for table nattapong51.productappbak420: ~12 rows (approximately)
REPLACE INTO `productappbak420` (`idProduct`, `NameProduct`, `Price`, `Numstock`) VALUES
	('P01', 'Paper A4 70 g.', 105, NULL),
	('P02', 'Paper A4 80 g.', 120, NULL),
	('P03', 'Paper F4 80 g.', 130, NULL),
	('P04', 'Paper B2 80 g.', 150, NULL),
	...
	('C01', 'Water Color Art', 250, 10),
	('C02', 'Color Penceils', 120, 20),
	('C03', 'Back Color Art', 70, 30),
	('C04', 'Blue Color', 40, 40),
	('C05', 'Back Color', 50, 50);
...
-- Dumping data for table nattapong51.productcopy2: 4 rows
